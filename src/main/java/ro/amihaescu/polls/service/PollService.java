package ro.amihaescu.polls.service;
...
import ro.amihaescu.polls.exception.BadRequestException;
import ro.amihaescu.polls.exception.ResourceNotFoundException;
import ro.amihaescu.polls.model.*;
import ro.amihaescu.polls.payload.PagedResponse;
import ro.amihaescu.polls.payload.PollRequest;
import ro.amihaescu.polls.payload.PollResponse;
import ro.amihaescu.polls.payload.VoteRequest;
...
import ro.amihaescu.polls.util.PollResponseMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        List<PollResponse> pollResponses = polls
                .map(poll -> PollResponseMapper.mapToPollResponse(
                        poll,
                        choiceVoteCountMap,
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        List<PollResponse> pollResponses = polls
                .map(poll -> PollResponseMapper.mapToPollResponse(poll,
                        choiceVoteCountMap,
                        user,
                        pollUserVoteMap == null ? null : pollUserVoteMap.getOrDefault(poll.getId(), null)))
                .getContent();
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        return PollResponseMapper.mapToPollResponse(poll, choiceVotesMap,
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        try {
            ...
            LOGGER.info("User {} has already voted in Poll {}", currentUser.getId(), poll.getId());
            throw  new BadRequestException("Sorry! You have already cast you vote in this poll");
        }
        ...
        return PollResponseMapper.mapToPollResponse(
    ...
    private void validatePageNumberAndSize(int page, int size) {
        ...
        if (size > AppConstants.MAX_PAGE_SIZE) {
            throw new BadRequestException(String.format("Page size cannot be greater than %s", AppConstants.MAX_PAGE_SIZE));
        }
    }
